...
def train(text_path: str | Path, vocab_size: int, model_prefix: str | None = None) -> Path:
    ...
    print(f"Trained: {model_file} (vocab={vocab_size})")
    return model_file
...
if __name__ == "__main__":
    ...
    train(args.input, args.vocab_size)
